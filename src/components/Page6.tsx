        ...
        <div className='flex flex-row w-full bg-white'>
            <div className='w-1/2 ml-14 mb-32'>
             ...
             <div className='w-2/5 rounded-xl border-2 border-gray-400 pl-[-250px] mt-20 mr-48 h-[220px] justify-center items-center'>
              <p className='text-black font-semibold text-xl text-center pt-2'>Your Body Speaks Volumes</p>
              <p className='text-black text-center xl:text-lg lg:text-sm md:text-sm p-2'>Understand your stress levels by tracking heart rate variability to identify patterns and triggers. Implement stress-reducing techniques to enhance your mental health and overall well-being.
